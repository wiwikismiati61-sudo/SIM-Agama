...
const Header: React.FC<HeaderProps> = ({ viewTitle, onToggleSidebar }) => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-md shadow-sm border-b border-slate-200 h-20 flex items-center justify-between px-4 md:px-6 lg:px-8 z-10 shrink-0 sticky top-0">
